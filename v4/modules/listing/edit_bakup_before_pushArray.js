...
//                        var typecheckexp = `console.log(dp_collections["${temp_collection}"].${temp}.constructor === Array) `;
//                        eval(typecheckexp);
//                        if (typecheckexp && typecheckexp.constructor === Array) {
//
//                            console.log(typecheckexp.constructor === Array);
//                            var exp = `Array.prototype.push.apply(dp_collections["${temp_collection}"].${temp},listing_info[key])`;
//                            eval(exp);
//                        } else {
