...
//                    dbLogger.move_data_api_log_setLogger(reqId, "INFO", new Date(), loggerObj)
//                    dbLogger.setLogger(req_reference_id, "INFO", new Date(), loggerObj)
//                    moved_info["mongo"].push({"collection": updateCollection, moved: true})
                }

//                  console.log("data moved to dp complweted for collection : ",updateCollection)
...
//            moved_info["mongo"].push({ moved: false, reason: Exception})
            resolve(resolveObj)
        }
