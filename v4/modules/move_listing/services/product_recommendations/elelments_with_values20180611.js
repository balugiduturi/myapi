module.exports = function (doc) {
    ...
    var facebook_likes = 0, facebook_posts = 0, twitter_tweets = 0, tweet_followers = 0;
    
    if (doc["social"] && doc["social"]["facebook"] && doc["social"]["facebook"]["likes"]){
    ...
    if (doc["social"] &&   doc["social"]["twitter"] && doc["social"]["twitter"]["followers_count"]){
        tweet_followers = doc["social"]["twitter"]["followers_count"]
    }
    elements_withValues["social_media_count"] = facebook_likes + facebook_posts + twitter_tweets + tweet_followers;
