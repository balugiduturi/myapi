...
function iterateBatch() {
    (async function () {
        ...
        cursor = await local_dbo.collection(local_collection).find({"_log.elastic_moved": 0}).limit(limit);
...
//                            }
                            ...
                            if (products_result) {
                                if (doc["recommended_products_details"]) {
                                    delete doc["recommended_products_details"];
                                }
                                if (doc["recommended_products_id"]) {
                                    delete doc["recommended_products_id"];
                                }
                                doc["recommended_products"] = products_result;
