...
module.exports = function (reqId, req_reference_id, moved_info, type, document, mongo_collection_instance) {
    return new Promise(async function (resolve, reject) {
        ...
        try {
            ...
            dbLogger.move_data_api_log_setLogger(reqId, "ELASTIC-MOVE STARTS", new Date(), "ELASTIC-MOVE STARTS");
            var elsatic_updated_obj = await  elasticInsert(indexDoc);
            dbLogger.move_data_api_log_setLogger(reqId, "ELASTIC-MOVE ENDS", new Date(), "ELASTIC-MOVE ENDS");
