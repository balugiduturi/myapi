        ...
        resolve((async function () {
            try {
                ...
                if (input.listing_source === 'private') {
                    ...
                    result = await client.search({index: elastic_indexes['projects_autosuggestion'] + "," + elastic_indexes['leads_without_url'],
...
//                input.listing_source = input.listing_source ? input.listing_source : 'public';
                ...
                if (input.listing_source === 'private') {
                    ...
                    result = await client.search({index: elastic_indexes['projects_autosuggestion'],
