...
//addlisting bulk
describe('ADDLISTING -Bulk', () => {

    /* add listing with proper data*/

    describe('/POST addlisting', () => {
        it('it should get acknowlegement with list of fp_ids', (done) => {

            chai.request(API_URl)
                .post('/v4/addlisting/bulk')
                .set("Authorization", "Bearer 5e0a50d50229b7f0a49c2c6f814e01a9258ac927")
                .send(addlisting_bulk_body)
                .end((err, res) => {
                    if (!err) {
